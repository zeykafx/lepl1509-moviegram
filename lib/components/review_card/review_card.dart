...
class _ReviewCardState extends State<ReviewCard> with AutomaticKeepAliveClientMixin {
  ...
  Future<bool> addLike() async {
    try {
      await FirebaseFirestore.instance.collection("reviews").doc(review!.reviewID).update({
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 8),
                SkeletonAvatar(style: SkeletonAvatarStyle(width: MediaQuery.of(context).size.width / 2, height: 30)),
              ],
            ),
          ],
        )),
